...
public class UIRightHandRayCast : MonoBehaviour
{
    ...
    public void FreezePickedUpItem(bool yn)
    {
        currentHeldObject.GetComponent<Rigidbody>().rotation = Quaternion.identity;
        currentHeldObject.GetComponent<Rigidbody>().freezeRotation = yn;
        currentHeldObject.GetComponent<Rigidbody>().useGravity = !yn;
    }
